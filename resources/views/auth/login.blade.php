...
<section class="new-post">
    <div class="new-post__content _container">
        <div class="new-post__top">
            ...
            <h2 class="new-post__title">Iniciar sesión</h2>
        </div>
        ...
        <form class="new-post__form" method="post" action="{{ route('user.login.submit') }}">
            @csrf
            <div class="new-post__field">
                <label class="new-post__label" for="email">Correo</label>
                <input class="new-post__input" id="email" type="email" name="email" value="{{ old('email') }}" placeholder="Correo">
            </div>
            <div class="new-post__field">
                <label class="new-post__label" for="password">Contraseña</label>
                <input class="new-post__input" id="password" type="password" name="password" placeholder="Contraseña">
            </div>
            <button class="button button-green" type="submit">Entrar</button>
            <a class="button button-green" href="{{ route('user.register') }}">Registro</a>
        </form>
