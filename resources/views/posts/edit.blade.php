...
<section class="new-post">
    <div class="new-post__content _container">
        <div class="new-post__top">
            ...
            <h2 class="new-post__title">Editar publicación</h2>
        </div>
        ...
        @include('posts.form', ['post' => $post, 'preselectedType' => null])
    </div>
</section>
@endsection

@push('scripts-before-body-end')
    <script src="{{ asset('js/posts/form.js') }}" defer></script>
@endpush
