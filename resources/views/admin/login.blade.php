...
<section class="new-post">
    <div class="new-post__content _container">
        ...
        <form class="new-post__form" method="post" action="{{ route('admin.login.submit') }}">
            @csrf
            <div class="new-post__field">
                <label class="new-post__label" for="email">Correo</label>
                <input class="new-post__input" id="email" type="email" name="email" value="{{ old('email') }}" placeholder="Email">
            </div>
            <div class="new-post__field">
                <label class="new-post__label" for="password">Contraseña</label>
                <input class="new-post__input" id="password" type="password" name="password" placeholder="Password">
            </div>
